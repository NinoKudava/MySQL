...
/*A table is created name "countries". No-preallocation of memory. SQL Server uses the unit of data storage, a page 8KB.
SQL had two types of extents, Uniform extents and Mixed extents. 
When a new table is created generally mixed extents are used (mixed extents are shared by up to eight objects).
When the table pages increasing to eigth pages the extents switch to uniform */

CREATE TABLE `countries` (

/*Create  character column definitions in character units using varchar() */
/**/
/*In SQL NULL is not a value, nor a state like for example true or fase, but it's the absence of any known value.
This means that the NULL value doesn't behave the same way when used in arithmetic, string manipulation, aggregation, or conditionals. */
`COUNTRY_ID` varchar(2) NOT NULL,
/*DEFAULT value is used for the field when an INSERT statement doesn't provide a value for it. */
...
/*Locks are in-memory structures which have owners, types, and the hash of the resource that is should protect
A lock memory structure is 96 bytes in size.*/
LOCK TABLES `countries` WRITE;
INSERT INTO `countries` VALUES ('AR','Argentina',2),('AU','Australia',3),('BE','Belgium',1),
														('BR','Brazil',2),('CA','Canada',2),('CH','Switzerland',1),('CN','China',3),('DE','Germany',1),
                                                        ('DK','Denmark',1),('EG','Egypt',4),('FR','France',1),('HK','HongKong',3),('IL','Israel',4),
                                                        ('IN','India',3),('IT','Italy',1),('JP','Japan',3),('KW','Kuwait',4),('MX','Mexico',2),('NG','Nigeria',4),
                                                        ('NL','Netherlands',1),('SG','Singapore',3),('UK','United Kingdom',1),('US','United States of America',2),
...
INSERT INTO `departments` VALUES (10,'Administration',200,1700),(20,'Marketing',201,1800),(30,'Purchasing',114,1700),
                                                            ...
                                                            (120,'Treasury',0,1700),(130,'Corporate Tax',0,1700),(140,'Control And Credit',0,1700),(150,'Shareholder Services',0,1700),
                                                            (160,'Benefits',0,1700),(170,'Manufacturing',0,1700),(180,'Construction',0,1700),(190,'Contracting',0,1700),(200,'Operations',0,1700),
                                                            (210,'IT Support',0,1700),(220,'NOC',0,1700),(230,'IT Helpdesk',0,1700),(240,'Government Sales',0,1700),(250,'Retail Sales',0,1700),
...
`STREET_ADRESS` varchar(40) DEFAULT NULL,
